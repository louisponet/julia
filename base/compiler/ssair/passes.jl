...
"""
function sroa_pass!(ir::IRCode, nargs::Int, getargescapes::T) where T
    ...
    simple_dce!(compact)
    ir = complete(compact)
    anymutability && sroa_mutables!(ir, nargs, getargescapes)
    return ir
end
...
function sroa_mutables!(ir::IRCode, nargs::Int, getargescapes::T) where T
    ...
    estate = analyze_escapes(ir, nargs, true, getargescapes)
